...
export default {
  ...
  mounted() {
    this.$store.dispatch("reqUserAddress");
  ...
  methods: {
    ...
    async submitOrder() {
      //orderNo参数
      let orderNo = this.orderInfo.tradeNo;
      //data参数
      let data = {
        consignee: this.userDefaultAddress.consignee, //用户名
        ...
        orderDetailList: this.orderInfo.detailArrayList, //订单商品
      };
      let result = await this.$API.reqSubmitOrder(orderNo, data);
      if (result.code == 200) {
