  ...
  <div class="register-container">
    ...
    <div class="register">
      <h3>
        注册新用户
        <span class="go"
          >我有账号，去 &nbsp;<span @click="to_login" class="to_login">登陆</span>
        </span>
      </h3>
      <div class="content">
        <label>手机号:</label>
      ...
      <div class="content">
        ...
        <input
          ...
          v-model="password"
          name="password"
          v-validate="{ required: true, regex: /^[A-Za-z0-9]{5,13}$/ }"
...
export default {
  ...
  methods: {
    async getCode() {
      try {
        //成功
        this.phone && (await this.$store.dispatch("reqGetCode", this.phone));
